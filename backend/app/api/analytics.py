...
def get_dashboard(
    ...
    try:
        ...
        return service.get_dashboard(start_date=start_date, end_date=end_date, category=category, region=region)
...
def get_monthly_sales(
    ...
    try:
        service = AnalyticsService(db)
        return service.get_monthly_sales(start_date=start_date, end_date=end_date, category=category, region=region)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
def get_category_sales(
    ...
    try:
        service = AnalyticsService(db)
        return service.get_category_sales(start_date=start_date, end_date=end_date, region=region)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
def get_regional_sales(
    ...
    try:
        service = AnalyticsService(db)
        return service.get_regional_sales(start_date=start_date, end_date=end_date, category=category)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
def get_top_products(
    ...
    try:
        service = AnalyticsService(db)
        return service.get_top_products(limit=limit, start_date=start_date, end_date=end_date, category=category, region=region)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
def export_dashboard_csv(
    ...
    try:
        service = AnalyticsService(db)
        dashboard_data = service.get_dashboard(start_date=start_date, end_date=end_date, category=category, region=region)
        ...
        for item in dashboard_data.monthly_sales:
            writer.writerow([item.month_name, item.year, item.revenue, item.orders, item.profit])
        writer.writerow([])
        ...
        writer.writerow([])
        writer.writerow(["Product ID", "Product Name", "Category", "Quantity Sold", "Revenue", "Profit"])
        for item in dashboard_data.top_products:
            writer.writerow([item.product_id, item.product_name, item.category, item.quantity_sold, item.revenue, item.profit])
