...
class AnalyticsRepository:
    ...
    def get_dashboard_kpis(self, start_date: str = None, end_date: str = None, category: str = None, region: str = None) -> Dict[str, Any]:
        """
        ...
        if category:
            query = query.join(Product, Order.product_id == Product.id).filter(Product.category == category)
        ...
        total_customers = query.with_entities(func.count(func.distinct(Order.customer_id))).scalar() or 0
        
        # Total products (unique products from filtered orders)
        total_products = query.with_entities(func.count(func.distinct(Order.product_id))).scalar() or 0
    ...
    def get_monthly_sales(self, start_date: str = None, end_date: str = None, category: str = None, region: str = None) -> List[Dict[str, Any]]:
        """
    ...
    def get_category_sales(self, start_date: str = None, end_date: str = None, region: str = None) -> List[Dict[str, Any]]:
        """
    ...
    def get_regional_sales(self, start_date: str = None, end_date: str = None, category: str = None) -> List[Dict[str, Any]]:
        """
        Get sales by region.
    ...
    def get_top_products(self, limit: int = 10, start_date: str = None, end_date: str = None, category: str = None, region: str = None) -> List[Dict[str, Any]]:
        """
